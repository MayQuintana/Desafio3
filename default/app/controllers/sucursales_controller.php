...
class SucursalesController extends RestController{
    ...
    public function get_paginador($page=1, $ppage=5){
           ...
           $this->data= (new Sucursales())->paginate("page: $page","per_page: $ppage", 'order: id desc');
    ...
    public function get_recurso($id){
             ...
             if($this->data= (new Sucursales())->find($id)){
