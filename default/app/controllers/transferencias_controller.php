...
class TransferenciasController extends RestController{
    ...
    public function get_paginador($page=1, $ppage=5){
           ...
           $this->data= (new Transferencias())->paginate("page: $page","per_page: $ppage", 'order: id desc');
    ...
    public function get_recurso($id){
             ...
             if($this->data= (new Transferencias())->find($id)){
   ...
   public function delete($id){
           ...
           if($this->data= (new Transferencias())->find($id)){
           if (!(new Transferencias())->delete($id)) {
