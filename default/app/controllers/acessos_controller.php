...
class AcessosController extends RestController{


     //Obtiene todos los recursos del estado
    public function getAll(){

             $this->data= (new Acessos())->find();
    ...
    public function get_paginador($page=1, $ppage=5){
           ...
           $this->data= (new Acessos())->paginate("page: $page","per_page: $ppage", 'order: id desc');
    ...
    public function get_recurso($id){
             ...
             if($this->data= (new Acessos())->find($id)){
             $this->data= (new Acessos())->find($id);
